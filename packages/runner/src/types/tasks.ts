...
interface EachFunctionReturn<T extends readonly any[]> {
  /**
...
interface TestEachFunction {
  <const T extends readonly any[]>(cases: readonly T[]): EachFunctionReturn<T>
  <const T>(cases: readonly T[]): EachFunctionReturn<[T]>
